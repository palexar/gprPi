...
fileNameS = "testRecordData.txt"
#use testRecordData for random data
# use scanTestD for actual scan data
...
#Constants FOR scanDat.txt use 0, 3, 6, 10
blueStartZone = 0
greenStartZone = 75
redStartZone = 80
redEndZone = 200
...
print("Rows and then Columns of Original")
print(len(datList)) # how many rows of data. need to find columns
rowsss = len(datList)
cols = 1 # columns of data
for j in datList[0]:
        if(j==' '):
                cols+=1
print(cols)
testFlip = [[] for i in range(cols)]
#print(testFlip)
#cou = 0
#for j in datList:
#        for elem in j:
...
print("ROWs and columns of flipp")
print(len(testFlip))
...
for i in datList:
        for j in i:
                if(j==' '):
                        ...
                        #print(addC)
                        testFlip[addC].append(digitToAdd)
                        addC+=1
                        digitToAdd=""
                else:
                        #digit continues
